    ...
    <div className="mt-4 space-y-4">
      ...
      {selectedZone && (
        <>
          ...
          {/* Panel */}
          <div className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border rounded-t-2xl animate-slide-up"
            ...
            {/* Component list */}
            <ScrollArea className="flex-1" style={{ maxHeight: 'calc(75vh - 100px)' }}>
