        ...
        <div className="rounded-2xl glass-card-strong p-8 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-transparent backdrop-blur-sm px-2 text-muted-foreground">Or continue with</span>
            </div>
          </div>

          <Button variant="outline" className="w-full border-border/50 bg-background/30 hover:bg-background/50" onClick={handleGoogleLogin}>
